...
```html
<script src="https://cdn.jsdelivr.net/npm/site-color-schemes@2.1.1/dist/site-color-schemes.min.js"></script>
```

or

```html
<script src="https://unpkg.com/site-color-schemes@2.1.1/dist/site-color-schemes.min.js"></script>
```
